...
- Pour les titres japonais contenant des kana, le merge ajoute des variantes romaji legeres basees sur la lecture hiragana/katakana. Ces variantes couvrent aussi un repli prudent des voyelles longues et une cle compacte sans espaces pour rapprocher les sources japonaises et les sources romanisees. Les titres avec kanji seuls ne sont pas translitteres automatiquement sans lecture fournie par un outil plus lourd.
...
- Les auteurs provisoires extraits depuis ces blocs utilisent les memes variantes romaji legeres, afin de ne pas bloquer une fusion lorsqu'un auteur en kana correspond a une source romanisee.
