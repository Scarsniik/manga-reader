...
contextBridge.exposeInMainWorld('api', {
    ...
    resetScraperLatestCheckpoints: (request: ResetScraperLatestCheckpointsRequest) => ipcRenderer.invoke('reset-scraper-latest-checkpoints', request),
    ...
    removeScraperReaderProgress: (request: RemoveScraperReaderProgressRequest) => ipcRenderer.invoke('remove-scraper-reader-progress', request),
