...
const buildReaderSettingsFields = (voicevoxOptions: VoicevoxFormOptions): FormItem[] => {
  ...
  },
  {
    ...
    fields: [
      ...
      {
        name: 'readerOcrVoicevoxAudioDownloadDirectory',
        label: 'Dossier de téléchargement audio OCR',
        type: 'text',
        placeholder: 'Vide : dossier utilisateur par défaut',
...
export default function ReaderSettingsPanel({ submitButtonId }: Props) {
  ...
  const onSubmit = async (values: Record<string, any>) => {
    ...
    await setParams({
      ...
      readerOcrVoicevoxSpeakerUuid: selectedSpeakerUuid,
      readerOcrVoicevoxStyleId: selectedStyleId,
      readerOcrVoicevoxAudioDownloadDirectory: normalizeReaderOcrVoicevoxAudioDownloadDirectory(
        values.readerOcrVoicevoxAudioDownloadDirectory,
      ),
